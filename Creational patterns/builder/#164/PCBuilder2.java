...
// --- PRODUCT with NON-static builder ---
class Computer {
    ...
    public Computer(Builder builder) {
        // in PCBuilder.java it was private inside STATIC inner class to prevent calling it directly by someone else
...
public class PCBuilder2 {
    public static void main(String[] args) {
        ...
        Computer budgetGamer = new Builder()
                                    .setCPU(new R5_7600())
